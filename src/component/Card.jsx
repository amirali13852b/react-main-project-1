...
const Card = ({ imageSrc, title, date, location, price, daysLeft }) => {
    return (
        <div className="relative h-96 w-auto rounded-lg overflow-hidden shadow-xl transform transition-all duration-300 hover:scale-105 cursor-pointer">
